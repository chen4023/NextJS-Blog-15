...
export default function Profile() {
  return (
    <div className="flex flex-col justify-center items-center py-4 bg-main">
      <Image src={profile} alt="profile" className="w-44 h-44 rounded-full mb-2" />
      <h2 className="font-bold text-xl">안녕하세요, 저는 현채은입니다.</h2>
